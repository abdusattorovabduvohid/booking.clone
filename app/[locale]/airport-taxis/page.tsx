...
import { FaTaxi, FaCalendarAlt, FaUser } from "react-icons/fa";

export default async function AirportTaxisPage({ params }: { params: Promise<{ locale: string }> }) {
          ...
          <div className="bg-[#febb02] p-1 rounded-lg shadow-lg w-full max-w-7xl">
            <div className="flex flex-col lg:flex-row gap-1">
              <div className="flex-1 flex items-center bg-white px-4 py-3 rounded-sm">
                ...
                <input type="text" placeholder="Enter pick-up location" className="w-full focus:outline-none text-gray-900 font-medium" />
              </div>
              <div className="flex-1 flex items-center bg-white px-4 py-3 rounded-sm">
                <FaTaxi className="text-gray-400 mr-3 text-xl" />
                <input type="text" placeholder="Enter destination" className="w-full focus:outline-none text-gray-900 font-medium" />
              </div>
              <div className="flex-1 flex items-center bg-white px-4 py-3 rounded-sm cursor-pointer hover:bg-gray-50">
                ...
                <span className="text-gray-500 font-medium whitespace-nowrap">Pick-up Date & Time</span>
              </div>
              <div className="flex-1 flex items-center bg-white px-4 py-3 rounded-sm cursor-pointer hover:bg-gray-50">
                <FaUser className="text-gray-400 mr-3 text-xl" />
                <span className="text-gray-900 font-medium whitespace-nowrap">2 Passengers</span>
              </div>
